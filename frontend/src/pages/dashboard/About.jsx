    ...
    <div className="max-w-3xl mx-auto px-6 py-8 space-y-8">
      ...
      <motion.div {...fadeUp(0)}>
        ...
        <p className="mt-2 text-muted-foreground text-sm leading-relaxed">
          Documentation complète de la plateforme Tekizz — mécaniques, modes de jeu et progression.
        </p>
      </motion.div>
      ...
      <motion.div {...fadeUp(0.05)}>
        <div className="rounded-2xl border border-border bg-card p-6 space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-black">Tekizz</h2>
              <p className="text-xs text-muted-foreground">Plateforme d'apprentissage par le jeu</p>
            </div>
          </div>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Tekizz est une plateforme d'apprentissage gamifiée conçue pour les étudiants, enseignants et
      ...
      <motion.div {...fadeUp(0.25)} className="border-t border-border pt-8 space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Tekizz v1.0 — Tous droits réservés</p>
      </motion.div>
    </div>
  );
}
