  ...
  return (
    <div className="space-y-5 pb-8">
      <div className="rounded-2xl border border-border bg-muted/20 p-4 space-y-1">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed">
          Tekizz est un projet ouvert. Que tu signales un bug, proposes une fonctionnalité
  ...
  return (
    <div className="space-y-5 pb-8">
      <div className="rounded-2xl border border-border bg-muted/20 p-4 space-y-1">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed">
          Tekizz est gratuit et le restera. Mais héberger, développer et maintenir une plateforme
    ...
    <div className="min-h-screen bg-background pb-8">
      <div className="max-w-2xl mx-auto px-4 pt-6 sm:px-6 sm:pt-10 space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Chacun contribue à sa façon. Choisis comment tu veux participer à l'évolution de Tekizz.
          </p>
        </div>
