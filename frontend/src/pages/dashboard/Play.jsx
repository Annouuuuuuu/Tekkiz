  ...
  return (
    <div className="min-h-screen bg-background px-6 py-10">
      <div className="max-w-5xl mx-auto space-y-10">
        <div>
          <p className="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Choose your game</p>
          <h1 className="mt-1 text-4xl font-black tracking-tight">Pick your arena.</h1>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          >
            ...
            <div className="relative p-8 flex flex-col gap-6">
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Multiple choice · ranked</p>
                  </div>
                </div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Answer rapid-fire questions under the clock. Every correct answer earns XP.
                Miss too many — you lose a life.
              </p>

              {/* Rules */}
              <div className="flex flex-wrap gap-4 text-xs text-muted-foreground">
                <span className="flex items-center gap-1.5"><Clock className="h-3.5 w-3.5" /> Global timer</span>
                <span className="flex items-center gap-1.5"><Heart className="h-3.5 w-3.5 fill-red-500 text-red-500" /> 3 lives</span>
              ...
              <button className="mt-2 flex items-center gap-2 text-sm font-black text-primary group-hover:gap-3 transition-all">
                Play QCM <ArrowRight className="h-4 w-4" />
              </button>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative p-8 flex flex-col gap-6">
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Speed matching · reflex</p>
                  </div>
                </div>
              ...
              {/* Description */}
              <p className="text-sm text-muted-foreground leading-relaxed">
                Match each term to its definition before time runs out.
                Reflexes, memory, and speed — all on the line.
              </p>

              {/* Rules */}
              <div className="flex flex-wrap gap-4 text-xs text-muted-foreground">
                <span className="flex items-center gap-1.5"><Timer className="h-3.5 w-3.5" /> Countdown timer</span>
                <span className="flex items-center gap-1.5"><Heart className="h-3.5 w-3.5 fill-red-500 text-red-500" /> 3 lives</span>
                <span className="flex items-center gap-1.5"><Shuffle className="h-3.5 w-3.5 text-orange-400" /> Combo bonus</span>
              </div>
              ...
              <button className="mt-2 flex items-center gap-2 text-sm font-black text-orange-400 group-hover:gap-3 transition-all">
                Play Smatch <ArrowRight className="h-4 w-4" />
              </button>
            </div>
          </motion.div>
        </div>
