...
const SECTIONS = [
  ...
  {
    title: "Vos droits",
    content: "Vous pouvez à tout moment consulter, modifier ou supprimer vos données depuis les paramètres de votre compte. Pour toute demande relative à vos données personnelles, contactez-nous à : privacy@tekizz.com.",
  },
  {
  ...
  {
    title: "Contact",
    content: "Pour toute question concernant cette politique, contactez-nous à : privacy@tekizz.com.",
  },
];
      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <header className="mb-12">
          ...
          <p className="mt-6 text-white/60 leading-relaxed">
            Chez Tekizz, la protection de vos données personnelles est une priorité. Cette politique explique quelles informations nous collectons, comment nous les utilisons et quels droits vous disposez concernant vos données.
          </p>
        </header>
