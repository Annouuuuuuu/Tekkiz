...
import {
  ...
  Settings, BarChart3, Layers, LogOut, Zap, Inbox,
} from "lucide-react";
...
const sections = [
  ...
  },
  {
    label: "QCM",
    items: [
      { to: "/admin/qcm/categories", label: "Categories", icon: Folder },
      ...
      { to: "/admin/qcm/config", label: "Config", icon: Settings },
    ],
  },
  {
    label: "Smatch",
    items: [
      ...
      { to: "/admin/smatch/config", label: "Config", icon: Settings },
    ],
  },
];
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-60 border-r border-border bg-card flex flex-col z-40">
      ...
      <div className="flex items-center gap-2 px-4 py-5 border-b border-border">
        ...
        <div>
          <p className="font-bold text-sm leading-none">Tekizz</p>
